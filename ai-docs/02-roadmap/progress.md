...
**Последнее обновление:** 2026-06-05 — production обновлён до code/media commit `e4be4e0`, media/history cleanup выполнен; T-8-112 закрыл public `/metrics` и включил fail2ban. Проверки и логи зафиксированы в `08-reports/T-8-111.md` и `08-reports/T-8-112.md`.
