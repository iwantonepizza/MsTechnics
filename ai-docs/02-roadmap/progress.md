...
| 8. Owner Feedback Round 2 | 🟢 14/21 → review | Фидбэк владельца после прод-проверки (2026-05-30). **Итерация 1 кодера: 14 задач сделаны** (отчёты в `08-reports/T-8-*`, backend 126 passed, typecheck clean): T-8-001/002/010/011/031/032/033/034/041/060/061/070/071/080 — контраст вкладок, матрица роль×кнопка, кружок состояния, 4 кнопки экрана, баги логина и двойного статуса, каскадное удаление, мобилка экрана отдела и др. **Осталось 7:** `T-8-003` заметки экрана, `T-8-004` тумблер история панель/место, `T-8-020` лента на главной, `T-8-035` daily-tasks, `T-8-062` тип истории ЗИП, `T-8-063` меню расходника ЗИП, `T-8-072` русификация админки. **Единый трекер: `ai-docs/09-user-tasks-round-2.md`** (статусы внутри). |
