...
1. Поправить nginx routing для внешних `/health/live/` и `/health/ready/`: сейчас они попадают в SPA fallback HTML.
...
**Последнее обновление:** 2026-06-05 — production обновлён до code/media commit `e4be4e0`, media/history cleanup выполнен, docs-only commits подтянуты без рестарта; проверки и логи зафиксированы в `08-reports/T-8-111.md`.
