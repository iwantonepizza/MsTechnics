...
- `T-8-113` закрыт и развёрнут: последние действия `Сегодня/Всё время`, upload FormData, активные счётчики заявок,
  мобильные задачи контроля.
...
**Последнее обновление:** 2026-06-05 — production обновлён до code commit `f4fa900`; T-8-113 закрыл новый owner feedback по activity/upload/application counts/mobile tasks. Проверки и логи зафиксированы в `08-reports/T-8-111.md`, `08-reports/T-8-112.md` и `08-reports/T-8-113.md`.
