...
> **Обновление 2026-06-04:** владелец сообщил о завершённой ротации перед production cutover.
> Текущий пароль VPS был повторно передан в агентском чате, поэтому его нужно ротировать ещё раз после завершения работ.
