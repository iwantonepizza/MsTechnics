...
/** T-8-020/T-8-110: лента последних действий с фильтрами периода и сущности. */
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {show ? (
          ...
          <div className="flex h-full items-center justify-center text-xs" style={{ color: 'var(--err)' }}>
            Не удалось загрузить последние действия
          </div>
        ) : data.length === 0 ? (
